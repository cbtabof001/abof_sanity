...
public class TestngListener implements ITestListener {
	...
	public static String reportPath="file:///C:/Users/Administrator/git/Reports/HTMLReports/index.html";
	...
	public void sendMail(int iPassCount, int iFailCount, int skippedCount, int iTotal_Executed,File pdfReports)
	{
		...
		String message = "<p>Hi Team,</p><div style=\"font-family:Verdana;\">Find the Sanity test automation report as below. For detail information, find the attached pdf file.</div><p></p><p></p><p></p><p></p>"
				+ "<p><div style=\"font-family:Verdana;\"><b> EXECUTION SUMMARY : </b></div></p>"
				+ "<p><div style=\"font-family:Verdana;\"><a href='ftp://111.93.145.49/SanityHTMLReports/index.html'>AbofReport</a></div></p>"
	   ...
	   try 
	   {
		   ...
		   msg.setSubject("Abof Sanity Execution Report on "+sdate);
